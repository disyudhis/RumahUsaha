<header class="bg-white shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            {{-- Mobile menu button --}}
            <button class="md:hidden p-2" x-data="{ open: false }" @click="open = !open" id="mobile-menu-button">
        ...
        <div class="md:hidden" x-data="{ open: false }" x-show="open" x-collapse>
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="#" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600">Profil
                    Usaha</a>
