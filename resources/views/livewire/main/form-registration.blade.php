        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-lg font-inter text-black max-w-2xl mx-auto">
                    Bergabunglah dengan komunitas UMKM RumahUsaha.id dan mulai memasarkan produk Anda kepada tetangga
                    sekitar
                </p>
            </div>
                    ...
                    {{-- <div class="border-t border-accent-200 pt-8">
                        <div class="flex items-start space-x-3">
                            ...
                            <label for="terms" class="text-sm text-secondary-700">
                                ...
                                serta <a href="#"
                                    class="text-primary-600 hover:text-primary-700 underline">Kebijakan Privasi</a>
                                RumahUsaha.id. Saya juga setuju untuk menerima komunikasi terkait platform melalui email
                                dan WhatsApp.
                            </label>
                        </div>
                        @error('terms')
